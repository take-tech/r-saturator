...
GitHub Actions では、`v0.1.0` のような Git タグをpushすると、インストーラーをGitHub Releaseへアップロードします。

## 開発状況

現在のバージョン: v0.1.0 prototype

このバージョンでは、まずDAWで読み込めて軽いサチュレーションができることを優先しています。
オーバーサンプリング、プリセット管理、カスタムLookAndFeel、コード署名/Notarizationは今後追加予定です。
